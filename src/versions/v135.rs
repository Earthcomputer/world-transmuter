use rust_dataconverter_engine::{convert_map_in_map, data_walker, DataWalkerMapListPaths, map_data_converter_func};
...
pub(crate) fn register(types: &MinecraftTypesMut) {
    ...
    types.player.borrow_mut().add_structure_walker(VERSION, data_walker(move |data, from_version, to_version| {
