...
pub(crate) fn register(types: &MinecraftTypesMut) {
    ...
    rename_block(types, VERSION, simple_rename("minecraft:purple_shulker_box", "minecraft:shulker_box"));
    rename_item(types, VERSION, simple_rename("minecraft:purple_shulker_box", "minecraft:shulker_box"));
}
