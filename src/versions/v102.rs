...
pub(crate) fn register(types: &MinecraftTypesMut) {
    ...
    types.tile_entity.borrow_mut().add_converter_for_id("FlowerPot", VERSION, map_data_converter_func(|data, _from_version, _to_version| {
    ...
    types.item_stack.borrow_mut().add_converter_for_id("minecraft:potion", VERSION, map_data_converter_func(|data, _from_version, _to_version| {
